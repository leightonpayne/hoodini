...
hive_dir = Path("/home/klaupaucius/software/hoodini/hoodini/data/contig_lengths")  # e.g., "hoodini/data/contig_lengths"
output_file = Path("/home/klaupaucius/software/hoodini/hoodini/data/contig_lengths/contig_lengths.parquet")
