        ...
        if rpath.is_file():
            ...
            if candidate.exists() and candidate.is_file():
                ...
                if files_inside:
                    ...
                    raise RuntimeError(f"No downloaded file found inside directory returned by downloader: {rpath}")
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("selected", nargs="?", default="all", help="Which DB(s) to download: all, pfam, phrogs, etc. Comma-separated.")
